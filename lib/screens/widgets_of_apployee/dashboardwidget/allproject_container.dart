    ...
    return Container(
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            const Text("All Projects",style: TextStyle(color:Colors.grey,fontSize: 20),),
            const SizedBox(height: 10,),

            const Text("No Activity",style: TextStyle(color:Colors.black,fontSize: 30)),
            const SizedBox(height: 10,),
            ...
            const SizedBox(height: 10,),
             ...
             Text(date,style: TextStyle(color:Colors.grey,fontSize: 20)),
          ],
        ),
      ),
    );
